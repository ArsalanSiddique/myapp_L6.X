...
<div class="col-md-9">
	<div class="card panel-primary" style="box-shadow: 3px 3px 5px 6px #ccc;">
		<div class="card-header">
			<div class="card-title"> <h3><b>Add Post</b></h3> </div>
		</div>
		<div class="card-body">
			<form action="{{route('posts.store')}}" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
			    <label for="inputCategoryTitle"><b>Post Title: </b></label>
			  ...
			  <div class="form-group">
			    <label for="inputCategoryThumbnail"><b>Thumbnail Im age: </b></label>
			    <input type="file" name="thumbnail" class="form-control" id="inputCategoryThumbnail">
			  </div>			  
			  <div class="form-group">
			    <label for="selectParent"><b>Select Categories: </b></label>
